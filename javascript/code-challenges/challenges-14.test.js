...
const screenForNames = (arr) => {
  ...
  let newArr=arr.filter(item=> regex.test(item));
  return newArr;
}
...
const detectTicTacToeWin = (board) => {
  // Solution code here...
  function helpCheck(row1, row2, row3){
...
return helpCheck(board[0], board[1], board[2]);
}
